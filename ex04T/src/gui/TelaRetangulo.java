...
public class TelaRetangulo extends javax.swing.JFrame {
    ...
    private void jButtonExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExecutarActionPerformed
        ...
        try {
            ...
            //ENTRADA DE DADOS
            Ret.setComprimento(Float.parseFloat(jTextFieldComprimento.getText()));
            Ret.setLargura(Float.parseFloat(jTextFieldLargura.getText()));

            //SAIDA DE DADOS
            String output = "DADOS DO RETÂNGULO\n"
                    + "Comprimento: " + Ret.getComprimento() + "\n"
